...
class LightFrameResource : public FrameResource
{
public:
    LightFrameResource(ID3D12Device* device,UINT passCount, UINT objectCount, UINT materialCount);
    virtual ~LightFrameResource() = default;
